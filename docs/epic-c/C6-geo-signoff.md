...
2. **Implement winsorizing (±3 SD) of dynamism_score** (C5 recommendation, still open; 149 obs
   currently beyond ±3 SD, max +13.4) before dynamism feeds E-series regressions or public visuals. **(Follow-up now tracked: #268 (QA-winsor) — see `docs/planning/deferred-work-audit-2026-07/README.md`.)**
