...
5. **D5 — BRW change is the theory-valuable, separately-built signal.** **(Follow-up now tracked: #263 (D3-brw-change) — see `docs/planning/deferred-work-audit-2026-07/README.md`.)** Any `brw_trend`/rent-gap
