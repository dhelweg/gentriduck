...
- **Known pitfall — mixing a structural level with dynamic signals (binding).** This is the
  ...
  the level, exactly as D4 separates levels from changes). **(Follow-up now tracked: #263 (D3-brw-change) — see `docs/planning/deferred-work-audit-2026-07.md`.)** Do not let the BRW *level* leak into a
