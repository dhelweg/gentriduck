...
|---|---|---|---|---|---|---|---|---|
| H1 | 436 | 0.87 | 0.7075 | 0.0127 | 0.6104 | 0.0355 | None — POI counts are independent of status_class_bi | total_poi_count, poi_cafe, poi_bar, poi_restaurant, poi_fast_food, poi_nightlife |
...
**H1**: AUC = 0.7075 ± 0.0127 (thesis: 0.87) — below thesis by -0.1625. F1w = 0.6104. n=436.
