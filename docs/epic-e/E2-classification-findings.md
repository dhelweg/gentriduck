...
|---|---|---|---|---|---|---|---|---|
| H1 | 436 | 0.87 | 0.7229 | 0.0364 | 0.6291 | 0.0303 | None — POI counts are independent of status_class_bi | total_poi_count, poi_cafe, poi_bar, poi_restaurant, poi_fast_food, poi_nightlife |
...
**H1**: AUC = 0.7229 ± 0.0364 (thesis: 0.87) — below thesis by -0.1471. F1w = 0.6291. n=436.
