...
when D5 lands. R-A1 leaves the slot; it does **not** populate it. **(Follow-up now tracked: #258 (D5-wire) — see `docs/planning/deferred-work-audit-2026-07/README.md`.)**
...
V-shapes and N-shapes when the full 7-edition panel (2013-2025) becomes available. **(Follow-up now tracked: #260 — see `docs/planning/deferred-work-audit-2026-07/README.md`.)**
