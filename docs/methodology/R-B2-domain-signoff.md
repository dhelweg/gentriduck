...
```json
{
  ...
  "recommendations": [
    "Extend seed to include 2-3 Lichtenberg/eastern Berlin pressure-zone PLRs in a follow-up ticket **(Follow-up now tracked: #264 — see `docs/planning/deferred-work-audit-2026-07.md`.)**",
