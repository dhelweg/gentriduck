...
```json
{
  ...
  "recommendations": [
    ...
    "Add a dynamism_index back-test as a follow-up ticket (post-G2 or as part of C5/R-A6) **(Follow-up now tracked: #264 — see `docs/planning/deferred-work-audit-2026-07.md`.)**"
  ]
}
```
