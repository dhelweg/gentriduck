...
- **Berlin "Stadtteile" (Ortsteile, 96): explicitly out of scope v1.** **(Follow-up now tracked: #269 (I-ortsteile) — see `docs/planning/deferred-work-audit-2026-07/README.md`.)** Ortsteile are not part of
...
- **What a coarse-level page shows (phased, gate-aware):**
  ...
  - *Not in this ticket:* computing a gentrification-index value at BZR/PGR/Bezirk grain. **(Follow-up now tracked: #267 (I-coarse-index) — see `docs/planning/deferred-work-audit-2026-07/README.md`.)** That is
