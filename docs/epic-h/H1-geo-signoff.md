...
2. Document the Stadtteil-grain effective-N / clustering requirement for D4 in any future Hamburg
   E1/E2-equivalent regression ticket (add to that ticket's acceptance criteria when filed). **(Follow-up now tracked: #265 (H-reg-SE) — see `docs/planning/deferred-work-audit-2026-07/README.md`.)**
