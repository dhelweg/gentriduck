...
-- STUB: Kauffälle (Verkaufte Grundstücke) 2024 — WFS endpoint not yet discovered.
--
...
-- D1b: discover Kauffälle WFS endpoint + implement ingestion
--
...
-- source_attribution varchar  -- dl-de-zero-2.0 attribution (expected licence)
--
...
-- STUB: Kauffaelle WFS endpoint returned 404 on 2026-06-18.
-- See issue D1b for resolution.
select
