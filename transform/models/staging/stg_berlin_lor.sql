...
{% set lor_glob = raw_path("berlin/lor/*_plr.parquet") %}
{%- set _src_raw_berlin_lor_plr = source("raw_berlin", "lor_plr") -%}
...
{% if file_count > 0 %}
    ...
    select
        ...
        geometry_wkb,
        source_attribution
    from read_parquet({{ _src_raw_berlin_lor_plr }}, union_by_name = true)
