...
This is the site's first page — a governed-index overview. Time-series trends, a choropleth map,
and per-area drill-down pages are being built next (see the project board).
